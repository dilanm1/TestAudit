<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditCorporate.aspx.cs" Inherits="AuditMgtNew.AuditCorporate" %>
...
<body>
  ...
  <br />
   ...
   <br />      
        <asp:table ID="tblAudit2" runat="server" border="0" style="font-size: 100%; font-family: Verdana;" >
            ...
            <asp:TableRow Width="100%">
                <asp:TableCell  Width="50%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Width="99%"></asp:TextBox> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="TextBox2" ErrorMessage="Evidence is missing!" 
                Font-Bold="True" 
                style="width: 5px; height: 19px" BackColor="#FF3300">Required</asp:RequiredFieldValidator></asp:TableCell>
                <asp:TableCell Width="50%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:TextBox ID="TextBox3"
      ...
      <asp:table ID="tblButtons" runat="server" border="0" style="font-size: 100%; font-family: Verdana;" >
            <asp:TableRow Width="100%">
                <asp:TableCell  Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"> <asp:ImageButton ID="ImageButton6" runat="server" onclick="ImageButton6_ServerClick" ImageUrl="~/Images/guidance_button.png" /></asp:TableCell>
                <asp:TableCell Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton7" runat="server" onclick="ImageButton7_ServerClick" ImageUrl="~/Images/references_button.png" /></asp:TableCell>
                <asp:TableCell Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/glossary_button.png" /></asp:TableCell>
                 <asp:TableCell Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"></asp:TableCell>
                 <asp:TableCell Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"></asp:TableCell>
                 ...
                 <asp:TableCell Width="5%" HorizontalAlign="right" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton9" runat="server" onclick="" ImageUrl="~/Images/previous_button.png" /></asp:TableCell>
 ...
 <asp:Panel ID="ModalPanel" runat="server" BorderColor="Black" BackColor="White" Height="550px"
  ...
  <asp:TextBox ID="TextBox4" runat="server" ForeColor="Black" Height="450px" 
            TextMode="MultiLine" Width="580px"  BackColor="White" BorderStyle="None" 
            BorderColor="White" AutoPostBack="True"></asp:TextBox>
 ...
 DropShadow="True" PopupDragHandleControlID="header" />
  ...
  <asp:Panel ID="Panel1" runat="server" BorderColor="Black" BackColor="White" Height="550px"
        ...
        <asp:TextBox ID="TextBox5" runat="server" ForeColor="Black" Height="450px" 
            TextMode="MultiLine" Width="580px"  BackColor="White" BorderStyle="None" 
            BorderColor="Silver" AutoPostBack="True"></asp:TextBox>
