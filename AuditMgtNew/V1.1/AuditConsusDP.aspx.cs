...
{
    public partial class AuditConsusDP : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.Page.PreviousPage != null)
            {
                ...
                ExaminationDP exam = new ExaminationDP(Int32.Parse(Session["mid"].ToString()), Int32.Parse(sid), sname, location);
                exam.GetQuestions();
        ...
        public void DisplayQuestion()
        {
            ...
            ExaminationDP e = (ExaminationDP)Session["questions"];
            // display data
        ...
        {
            ExaminationDP exam = (ExaminationDP)Session["questions"];
        ...
        protected void btnNext_ServerClick(object sender, EventArgs e)
        {
            ...
            // Response.Redirect("showresult.aspx");
            {
                ...
                SqlDataAdapter da5 = new SqlDataAdapter("select * from tblQuestionsDPSub where sid = " + q3.sid, con5);
