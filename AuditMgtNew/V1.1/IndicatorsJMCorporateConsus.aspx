<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndicatorsJMCorporateConsus.aspx.cs" Inherits="AuditMgtNew.IndicatotrJMCorporate" %>
...
<body>
    ...
    <center>
     <asp:table ID="tblIndicatorJM" runat="server" border="0" Width ="75%"
            ...
            Height="80px" >
    <asp:TableRow>
    <asp:TableCell HorizontalAlign="left" Width="80%" Text="Location:">
        ...
        <Columns>
          ...
          <%--  <asp:BoundField DataField="Country" HeaderText="Country" />--%>
           <asp:TemplateField>
                ...
                <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Start Audit" PostBackUrl='<%# "~/AuditConsusJM.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
         ...
         <asp:BoundField DataField="status" HeaderText="id" />
          <asp:TemplateField>
          <ItemTemplate>
                 <asp:LinkButton ID="Button1" runat="server" Text="Edit" PostBackUrl='<%# "~/GridViewEditConsusCorporateJM.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
            </ItemTemplate> 
         </asp:TemplateField>
         <asp:TemplateField>
          <ItemTemplate>
                 <asp:LinkButton ID="Button2" runat="server" Text="Resume" PostBackUrl='<%# "~/AuditSaved.aspx?RowIndex=" + Container.DataItemIndex %>' Visible="False"></asp:LinkButton>
            </ItemTemplate> 
         </asp:TemplateField> 
          <asp:TemplateField>
          <ItemTemplate>
