<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditReviewSecondTierJM.aspx.cs" Inherits="AuditMgtNew.AuditReviewSecondTierJM" %>
...
<body>
  ...
  <%--  <asp:CustomValidator id="CustomValidator1" runat="server" Visible="true" 
     ...
     <p>
     <br />
    <asp:Label ID="lblcurrentCS" runat="server" Text="Current Conformance Status:" 
    ...
    <br />
    <p>
        <asp:Label ID="Label3" runat="server" Text="Reviewed Conformance Status:" 
            ForeColor="#878787"></asp:Label><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                ControlToValidate="TextBox3" ErrorMessage="Evidence is missing!" 
                Font-Bold="True" 
                style="width: 5px; height: 19px" BackColor="#FF3300">Required</asp:RequiredFieldValidator>--%>
        ...
        <asp:table ID="tblAudit2" runat="server" border="0" style="font-size: 100%; font-family: Verdana;" >
            <asp:TableRow Width="100%">
                ...
                <asp:TableCell Width="400" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small">Auditors Comments</asp:TableCell>
                 <asp:TableCell Width="400" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small">External Auditors Comments</asp:TableCell>
            </asp:TableRow>
            <asp:TableRow Width="100%">
                <asp:TableCell  Width="33%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Width="97%"></asp:TextBox> <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ...
                <asp:TableCell Width="33%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:TextBox ID="TextBox3"
            runat="server" TextMode="MultiLine" Width="97%"></asp:TextBox><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ...
                Font-Bold="True" 
                style="width: 5px; height: 19px" BackColor="#FF3300" EnableClientScript="False" ClientIDMode="Static">Required</asp:RequiredFieldValidator>--%></asp:TableCell>
            <asp:TableCell Width="33%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:TextBox ID="txtauditor"
            runat="server" TextMode="MultiLine" Width="97%"></asp:TextBox><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ControlToValidate="TextBox3" ErrorMessage="Comments is missing!" 
                Font-Bold="True" 
                style="width: 5px; height: 19px" BackColor="#FF3300" EnableClientScript="False" ClientIDMode="Static">Required</asp:RequiredFieldValidator>--%></asp:TableCell>
