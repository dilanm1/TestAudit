...
{
    public partial class SelectSBUConsusTC : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string query = ("select distinct locationid,location from tbllocation2 where verticalid =" + 3);
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("IndicatorsTCConsus.aspx");  
