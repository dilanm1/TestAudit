<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewEditConsusTC.aspx.cs" Inherits="AuditMgtNew.GridViewEditConsusTCSbu" %>
...
<body>
    ...
    <div id="header">
        <asp:Image ID="Image1" runat="server" Height="77px" 
            ImageUrl="~/Images/tecom_logo.png" Width="178px" />
        <ul>
    ...
    <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT * FROM [tblSavedAnswersConsus] WHERE ([location] = @location)" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [locationid], [location] FROM [tbllocation2] WHERE ([verticalid] = @verticalid)">
            <SelectParameters>
