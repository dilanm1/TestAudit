...
{
    public partial class AuditCorporate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Page.PreviousPage != null)
            {
                ...
                ExaminationCorporate exam = new ExaminationCorporate(Int32.Parse(Session["mid"].ToString()), Int32.Parse(sid), sname, location);
                exam.GetQuestions();
        ...
        public void DisplayQuestion()
        {
            ...
            ExaminationCorporate e = (ExaminationCorporate)Session["questions"];
            // display data
            ...
            myDataAdapter = new SqlDataAdapter("SELECT guid FROM tblQuestionsJMSubCorp  WHERE qid = '" + q.qid + "' ", con3);
            ...
            myDataAdapter1 = new SqlDataAdapter("SELECT ref FROM tblQuestionsJMSubCorp WHERE qid = '" + q.qid + "' ", con);
        ...
        {
            ExaminationCorporate exam = (ExaminationCorporate)Session["questions"];
        ...
        protected void btnNext_ServerClick(object sender, EventArgs e)
        {
            ...
            if (exam.curpos == exam.SIZE - 1)
            {
                ...
                cmd.CommandText = "insert into tblSavedAnswersCorporateJM values(@mid,@examid,@sid,@qid,@question,@answer,@evidence,@comments)";
                ...
                SqlDataAdapter da5 = new SqlDataAdapter("select * from tblQuestionsJMSubCorp where sid = " + q.sid, con5);
                ...
                SqlCommand cmd3 = new SqlCommand("Update oe_subjects_corporate Set score=@score,status=@status  WHERE sid =@sid", con6);
        ...
        protected void ImageButton8_ServerClick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Session.Contents.Count; i++)
            {
                ...
                SqlCommand cmd = new SqlCommand("select isnull( max(examid),0) + 1 from oe_exams", con);
                int examid = (Int32)cmd.ExecuteScalar();
                cmd.CommandText = "insert into tblSavedAnswersAuditorCorporateJM values(@mid,@examid,@sid,@qid,@question,@answer,@evidence,@comments)";
                cmd.Parameters.Add("@examid", SqlDbType.Int).Value = examid;
                cmd.Parameters.Add("@mid", SqlDbType.Int).Value = exam.mid;
                cmd.Parameters.Add("@sid", SqlDbType.Int).Value = exam.sid;
                cmd.Parameters.Add("@qid", SqlDbType.NVarChar).Value = q.qid;
