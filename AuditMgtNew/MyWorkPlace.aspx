<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyWorkPlace.aspx.cs" Inherits="AuditMgtNew.MyWorkPlace" %>
        ...
        <Columns>
          ...
          <%--  <asp:BoundField DataField="Country" HeaderText="Country" />--%>                   
           <asp:TemplateField>
                ...
                <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Start Audit" PostBackUrl='<%# "~/Audit1.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
         ...
         <asp:BoundField DataField="status" HeaderText="id" />
          <asp:TemplateField>
          <ItemTemplate>
                 <asp:LinkButton ID="Button1" runat="server" Text="Edit" PostBackUrl='<%# "~/GridViewEditJMSub.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
            </ItemTemplate> 
         </asp:TemplateField>
         <asp:TemplateField>
          <ItemTemplate>
